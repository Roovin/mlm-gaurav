                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body" style="margin-left: 205px">                                        
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" name="name" value="<?php echo $customer_name; ?>" disabled>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="email"  name="email" value="<?php echo $result['email']; ?>" placeholder="email" disabled>
                                                <div class="invalid-feedback">
                                                    Please provide a valid Mobile.
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="mobile"  name="mobile" value="<?php echo $result['mobile']; ?>" placeholder="Mobile" >
                                                <div class="invalid-feedback">
                                                    Please provide a valid Mobile.
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="example-search-input" class="col-sm-2 col-form-label">D.O.B</label>
                                            <div class="col-sm-8">
                                                <input class="form-control" type="date"  name="date" value="<?php echo $result['dob']; ?>" placeholder="D.O.B">
                                                <div class="invalid-feedback">
                                                    Please provide a valid Mobile.
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text"  name="address" value="<?php echo $result['address']; ?>" placeholder="Address" >
                                                <div class="invalid-feedback">
                                                    Please provide a valid Mobile.
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text"  name="adharCard" placeholder="Adhar Card Number" value="<?php echo $result['adhar'] ?>" minilength="12" maxlength="12" pattern="[0-9]{4}[0-9]{4}[0-9]{4}" >
                                                <div class="invalid-feedback">
                                                    Please provide a valid Mobile.
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text"  name="pancard" value="<?php echo $result['pan']; ?>" placeholder="PAN Number"  >
                                                <div class="invalid-feedback">
                                                    Please provide a valid Mobile.
                                                </div>
                                            </div>
