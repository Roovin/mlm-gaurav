                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap " style="border-collapse: collapse; border-spacing: 0; width: 100%; ">
                                            ...
                                            <?php                                            
                                            $sql = "SELECT * FROM customers WHERE status='No Approved'";
                                            $cnt=1;
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo htmlentities($r['customer_id'])?></td>
                                                <td><?php echo htmlentities($r['name'])?></td>
                                                <td><?php echo htmlentities($r['email'])?></td>
                                                <td><?php echo htmlentities($r['mobile'])?></td>
                                                <td><?php echo htmlentities($r['rupees'])?></td>
                                                <td id="viewchallan-<?php echo $r['customer_id']; ?>" onclick="member_ntf(this);"><button>Approve</button></td>
