                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                    ...
                                    <span>Products &amp Packages</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="distributors.php">Add Distributors</a></li>
                                    <li><a href="manage_distributors.php">Manage Distributors</a></li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li><a href="customers_application.php">Customers Application</a></li>
                                    <li><a href="fund_transfer_report.php">Fund Transfer Report</a></li>                                    
                                    <li><a href="profit_calculation.php">Profit Calculation</a></li>
                                    <li><a href="profit_transfer.php">Profit Transfer</a></li>
                                    <!--<li><a href="ui-dropdowns.html">Dropdowns</a></li>
                                    <li><a href="ui-grid.html">Grid</a></li>
                                    <li><a href="ui-images.html">Images</a></li>
                                    <li><a href="ui-lightbox.html">Lightbox</a></li>
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                    <i class="ti-package"></i>
                                    <span>Member Notification</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="member_notification.php">member notification </a></li>
                                    <!-- <li><a href="customers_application.php">Customers Application</a></li>
                                    <li><a href="fund_transfer_report.php">Fund Transfer Report</a></li>                                    
                                    <li><a href="profit_calculation.php">Profit Calculation</a></li>
                                    <li><a href="profit_transfer.php">Profit Transfer</a></li> -->
                            ...
                            <!-- <li><a href="customers/index.php">Customers Dashboard</a></li> -->
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                    <i class="ti-package"></i>
                                    <span>News</span>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <!-- <li><a href="ui-buttons.html">Manage News</a></li> -->
                                    <!-- <li><a href="ui-cards.html">Cards</a></li> -->
                                    <!--<li><a href="ui-carousel.html">Carousel</a></li>
                                    <li><a href="ui-dropdowns.html">Dropdowns</a></li>
                                    <li><a href="ui-grid.html">Grid</a></li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="add_fund.php">Add Fund</a></li>
                                    <li><a href="transfer_fund.php">Transfer Fund</a></li>
