                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="dashboard.php" class="logo logo-dark">
                                ...
                                <span class="logo-lg">
                                    <img src="assets/images/simpays-pink.png" alt="" height="17">
                                </span>
                            </a>

                            <a href="dashboard.php" class="logo logo-light">
                                <span class="logo-sm">
                                    <img src="assets/images/simpays-pink.png" style="width: 65px;height: 77px; margin-top: 17px;" alt="" height="22">
                                </span>
                                <span class="logo-lg">
                                    <img src="assets/images/simpays-pink.png" style="width: 65px;height: 77px; margin-top: 17px;" alt="" height="18">
                                </span>
                            </a>
                        </div>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <!-- item-->
                                <a class="dropdown-item" href="#"><i class="mdi mdi-account-circle font-size-17 align-middle mr-1"></i> <?php echo ucfirst($_SESSION['admin']); ?></a>
