                                ...
                                <div class="card mini-stat bg-primary text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h5 class="font-size-16 text-uppercase mt-0 text-white-50">Active Amount</h5>
                                            <?php 
                                                $sql = mysqli_query($conn, "SELECT active_fund, total_transfer FROM admin WHERE username = '$admin_name'");
                                                $result = mysqli_fetch_array($sql);
                                            ?>
                                            <h4 class="font-weight-medium font-size-24"><?php echo $result['active_fund']; ?>
                                        ...
                                        <div class="pt-2">
                                            <div class="float-right">
                                                <a href="fund_transfer.php" class="text-white-50"><i class="mdi mdi-arrow-right h5"></i></a>
                                            </div>

                                            <p class="text-white-50 mb-0 mt-1">Active Amount</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card mini-stat bg-primary text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h5 class="font-size-16 text-uppercase mt-0 text-white-50">Total Pay-out Given</h5>
                                            <h4 class="font-weight-medium font-size-24"><?= $result['total_transfer']; ?>
                                        ...
                                        <div class="pt-2">
                                            ...
                                            <p class="text-white-50 mb-0 mt-1">Total Pay-out Given</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card mini-stat bg-primary text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h5 class="font-size-16 text-uppercase mt-0 text-white-50">Active Member</h5>
                                            <h4 class="font-weight-medium font-size-24">15
                                                 <!-- <i class="mdi mdi-arrow-up text-success ml-2"></i></h4> -->
                                        ...
                                        <div class="pt-2">
                                            ...
                                            <p class="text-white-50 mb-0 mt-1">Active Member</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card mini-stat bg-primary text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h5 class="font-size-16 text-uppercase mt-0 text-white-50">Non-Active Members</h5>
                                            <h4 class="font-weight-medium font-size-24">124
                                                <!-- <i class="mdi mdi-arrow-up text-success ml-2"></i></h4> -->
                                        ...
                                        <div class="pt-2">
                                            ...
                                            <p class="text-white-50 mb-0 mt-1">Non-Active Members</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="text-center">
                                                            <p class="text-muted mb-4">Current Month Sale</p>
                                                            <h3>$34,252</h3>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="text-center">
                                                            <p class="text-muted mb-4">Current Week Sale</p>
                                                            <h3>$36,253</h3>
                                                            <p class="text-muted mb-5">It will be as simple as in fact it
                                                                will be occidental.</p>
                                                            <span class="peity-donut"
                                                ...
                                                <div class="card mini-stat bg-primary text-white">
                                                    <div class="card-body">
                                                        <div class="mb-4">
                                                            ...
                                                            <h5 class="font-size-16 text-uppercase mt-0 text-white-50">Current Month Total Pay-Out</h5>
                                                            <h4 class="font-weight-medium font-size-24">15.8
                                                                <!-- <i class="mdi mdi-arrow-up text-success ml-2"></i></h4> -->
                                                            <!-- <div class="mini-stat-label bg-info">
                                                                <p class="mb-0"> 00%</p>
                                                            </div> -->
                                                        ...
                                                        <div class="pt-2">
                                                            ...
                                                            <p class="text-white-50 mb-0 mt-1">Current Month Total Pay-Out</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- </div> -->
                                            ...
                                            <div class="card mini-stat bg-primary text-white">
                                                    <div class="card-body">
                                                        <div class="mb-4">
                                                            ...
                                                            <h5 class="font-size-16 text-uppercase mt-0 text-white-50">Current Week Total Pay-Out</h5>
                                                            <h4 class="font-weight-medium font-size-24">15.8
                                                                <!-- <i class="mdi mdi-arrow-up text-success ml-2"></i></h4> -->
                                                            <!-- <div class="mini-stat-label bg-info">
                                                                <p class="mb-0"> 00%</p>
                                                        ...
                                                        <div class="pt-2">
                                                            ...
                                                            <p class="text-white-50 mb-0 mt-1">Current Week Total Pay-Out</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- <div class="card mini-stat bg-primary text-white">
                                        ...
                                        <div class="card bg-primary">
                                            <div class="card-body">
                                                <div class="text-center text-white py-4">
                                                    <h5 class="mt-0 mb-4 text-white-50 font-size-16">New Profit This Month</h5>
                                                    <h1>1452</h1>
                                                ...
                                                <div class="text-center text-white py-4">
                                                    <h5 class="mt-0 mb-4 text-white-50 font-size-16">Total</h5>
                                                    <h1>1452</h1>
                                                    <!-- <p class="font-size-14 pt-1">Computer</p>
                                                    <p class="text-white-50 mb-0">At solmen va esser necessi far uniform
                                                        myth... <a href="#" class="text-white">View more</a></p> -->
