...
$sql = "UPDATE stores SET distri_id='$distri_id',owner_name='$owner_name',owner_phone='$owner_phone',owner_address='$owner_address',store_state='$store_state',store_city='$store_city',store_address='$store_address',profit_on_bv='$profit_bv',security_amount='$security_amount',password='$password',active_status='$active_status',network_id='$network_id' WHERE id='$database_id'";
