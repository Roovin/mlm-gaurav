...
$sql = "SELECT status FROM profit_database WHERE customer_id='$cust' AND month='$pmonth' AND year='$pyear'";
$res = mysqli_query($con,$sql);
...
{
	$sql = "DELETE FROM profit_database WHERE customer_id='$cust' AND month='$pmonth' AND year='$pyear'";
	$res = mysqli_query($con,$sql);
	$allow = "Done";
}
else
