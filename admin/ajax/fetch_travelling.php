...
while($r=mysqli_fetch_array($res,MYSQLI_ASSOC))
{
	...
	echo '<div class="return-row">
			...
			<div class="return-data" style="width:90px;"><b>'.$r['quantity'].'</b></div>
			<div class="return-data" style="width:90px;border-right:0px;"><button class="accept_button" id="accept-'.$r['id'].'" onclick="accept_product(this);">Accept</button></div>
		</div>';
}
