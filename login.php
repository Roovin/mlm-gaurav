...
if(isset($_POST['register'])){
    ...
    $pincode = $_POST['pincode'];
        ...
        $sql = "INSERT INTO users(sponser_id, username, email, contact, password, address, city, state, pincode) VALUES('$sponser_id', '$username','$email','$phone','$password', '$address', '$city', '$state', '$pincode')";
...
if(isset($_POST['login'])){
    ...
    // print_r($_POST['email2']);

    $email2=$_POST['email2'];
    $password=md5($_POST['password']);
    $query=mysqli_query($conn,"select * FROM users WHERE email='$email2' AND password='$password'");
    ...
    if($result=mysqli_fetch_array($query)){
        ...
        if($_SESSION['id']){
            $query2=mysqli_query($conn,"UPDATE cart SET userId='".$result['id']."' WHERE userId=0");
            // $d = base64_encode($pid);
                                    ...
                                    <div class="login-register-form">
                                        <form method="post">
                                            ...
                                            <div class="button-box">
                                                ...
                                                <div class="button-box">
                                                    <button class="login-btn btn" name="login"><span>Login</span></button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                            ...
                            <div id="lg2" class="tab-pane">
                                <div class="login-form-container">
                                    <div class="login-register-form">
                                        <form method="post">
                                            <div class="login-input-box">
                                            <input type="text" name="sponser_id" style="width: 175px"  id="sponser" placeholder="Sponser Id" class="form-control"/>
                                            ...
                                            <div class="button-box">
                                                <button class="register-btn btn"  name="register"><span>Register</span></button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
